...
#####
#Lista
list_of_single_column = iris['sepal length'].tolist()
print('Sepal length:', list_of_single_column,type(list_of_single_column))
#Diccionario
dic_sepal_width = iris.set_index('sepal width').T.to_dict('list')
print('Sepal Width:',dic_sepal_width,type(dic_sepal_width))
#Tupla
tupla_petal_length = iris['petal length'].tolist()
tupla = tuple(tupla_petal_length)
